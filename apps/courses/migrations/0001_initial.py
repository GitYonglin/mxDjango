# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-02-21 05:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('cj', '中级'), ('zj', '中级'), ('gj', '高级')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(upload_to='Course/resource/%Y/%m', verbose_name='视频文件')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
